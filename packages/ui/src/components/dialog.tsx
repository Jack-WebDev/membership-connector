	...
	return (
		<DialogPortal>
			...
			<DialogPrimitive.Popup
				...
				className={cn(
					"data-open:fade-in-0 data-open:zoom-in-95 data-closed:fade-out-0 data-closed:zoom-out-95 fixed top-1/2 left-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-[calc(var(--radius)*1.15)] bg-popover p-5 text-popover-foreground text-xs/relaxed shadow-[var(--shadow-soft)] outline-none ring-1 ring-foreground/10 duration-100 data-closed:animate-out data-open:animate-in sm:max-w-sm",
					className,
				)}
				{...props}
			>
