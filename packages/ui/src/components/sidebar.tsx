...
import { Separator } from "@membership-connector-app/ui/components/separator";
import {
	Sheet,
	SheetContent,
	SheetDescription,
	SheetHeader,
	SheetTitle,
} from "@membership-connector-app/ui/components/sheet";
import { Skeleton } from "@membership-connector-app/ui/components/skeleton";
import {
	Tooltip,
	TooltipContent,
	TooltipTrigger,
} from "@membership-connector-app/ui/components/tooltip";
import { useIsMobile } from "@membership-connector-app/ui/hooks/use-mobile";
		...
		>
			...
			>
				<div
					...
					className="flex size-full flex-col bg-[linear-gradient(180deg,rgb(255_255_255_/_0.78),rgb(236_243_249_/_0.94))] group-data-[variant=floating]:rounded-[1.5rem] group-data-[variant=floating]:shadow-[var(--shadow-card)] group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-white/55 dark:bg-[linear-gradient(180deg,rgb(27_40_51_/_0.96),rgb(20_31_40_/_0.96))]"
				>
					{children}
				</div>
			</div>
...
const sidebarMenuButtonVariants = cva(
	"peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-none p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-active:bg-sidebar-accent data-active:font-medium data-active:text-sidebar-accent-foreground data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0",
	{
		variants: {
			variant: {
